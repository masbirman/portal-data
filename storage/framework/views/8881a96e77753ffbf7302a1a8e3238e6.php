<div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="group bg-white rounded-xl p-6 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.1)] hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border border-slate-100">
            ...
            <div>
                <h3 class="text-3xl font-bold text-slate-800 mb-1"><?php echo e(number_format($stats['total_sekolah'])); ?></h3>
        ...
        <div class="group bg-white rounded-xl p-6 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.1)] hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border border-slate-100">
            ...
            <div>
                <h3 class="text-3xl font-bold text-slate-800 mb-1"><?php echo e(number_format($stats['total_peserta'])); ?></h3>
        ...
        <div class="group bg-white rounded-xl p-6 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.1)] hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border border-slate-100">
            ...
            <div>
                <h3 class="text-3xl font-bold text-slate-800 mb-1"><?php echo e($stats['kemandirian']); ?>%</h3>
        ...
        <div class="group bg-white rounded-xl p-6 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.1)] hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border border-slate-100">
            ...
            <div>
                <h3 class="text-3xl font-bold text-slate-800 mb-1"><?php echo e($stats['keikutsertaan']); ?>%</h3>
                <p class="text-sm text-slate-500">Rata-rata Partisipasi</p>
            </div>
        </div>
    </div>
</div>
<?php /**PATH /var/www/resources/views/livewire/public/stats-overview.blade.php ENDPATH**/ ?>