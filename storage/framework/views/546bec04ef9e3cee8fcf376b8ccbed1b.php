<div class="mt-8 bg-white rounded-lg shadow-lg p-6">
    ...
    <div x-data="trendChart(<?php echo \Illuminate\Support\Js::from($chartData)->toHtml() ?>)" x-init="initChart" class="w-full h-[350px]">
        <div x-ref="chart"></div>
    </div>
...
<?php /**PATH /var/www/resources/views/livewire/public/trend-chart.blade.php ENDPATH**/ ?>