<x-filament-panels::page>
    ...
    @if (!$isGoogleConnected)
        <x-filament::section style="margin-bottom: 2rem; background: #fef3c7; border: 1px solid #f59e0b;">
            <div style="display: flex; align-items: center; justify-content: space-between;">
                <div style="display: flex; align-items: center; gap: 1rem;">
                    <span style="font-size: 2rem;">⚠️</span>
                    <div>
                        <p style="font-weight: 600; color: #92400e;">Google Drive Belum Terhubung</p>
                        <p style="font-size: 0.875rem; color: #a16207;">Hubungkan akun Google Drive untuk mulai backup
                        </p>
                    </div>
                </div>
                <x-filament::button wire:click="connectGoogle" color="warning" icon="heroicon-o-link">
    ...
    @else
        ...
        <div style="display: flex; gap: 1rem; margin-bottom: 2rem; align-items: center;">
            ...
            <div style="margin-left: auto; display: flex; align-items: center; gap: 0.5rem;">
                <span style="color: #16a34a;">✓ Google Drive Terhubung</span>
                <x-filament::button wire:click="disconnectGoogle" color="danger" size="sm"
        ...
        <x-filament::section style="margin-bottom: 2rem;">
            ...
            @else
                <div style="text-align: center; padding: 3rem;">
                    ...
                    <p style="font-size: 0.875rem; color: #9ca3af; margin-top: 0.5rem;">Klik tombol Backup Sekarang
                        untuk membuat backup pertama</p>
                </div>
            @endif
        </x-filament::section>
    @endif
