<div>
    ...
    <div class="mb-4 flex flex-col md:flex-row gap-4 justify-between items-center">
        ...
        <a href="{{ route('download-request.index') }}" class="flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors whitespace-nowrap">
