<div>
    ...
    <div class="mb-6">
        <div class="grid grid-cols-6 lg:grid-cols-11 gap-2">
            ...
            @foreach ($jenjangList as $jenjang)
                <button type="button" wire:click="setJenjangFilter({{ $jenjang->id }})" wire:key="jenjang-{{ $jenjang->id }}"
                    class="px-3 py-1.5 text-sm rounded-lg font-semibold transition-colors duration-150
    ...
    <div class="mb-4 flex flex-col md:flex-row gap-4 justify-between items-center">
        ...
        <button wire:click="export" wire:loading.attr="disabled" class="flex items-center gap-2 px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors disabled:opacity-50">
