            ...
            <div class="bg-white p-2 rounded-xl shadow-sm border border-gray-100 h-[160px] flex items-center">
                ...
                <div class="relative w-[60%] h-full flex items-center justify-center">
                    ...
                    <div class="absolute inset-0 flex items-center justify-center pointer-events-none z-10">
                        <span class="text-[10px] font-bold text-gray-700 text-center leading-tight px-1">{{ $jenjang }}</span>
                    </div>
        ...
        <div>
            ...
            <div class="grid grid-cols-3 gap-2 mb-4">
                 <div class="flex items-center space-x-2">
                    ...
                    <div>
                        <div class="text-xs font-bold">{{ number_format($this->stats['totals']['status']['mandiri'], 0, ',', '.') }}</div>
                 ...
                 <div class="flex items-center space-x-2">
                    ...
                    <div>
                        <div class="text-xs font-bold">{{ number_format($this->stats['totals']['status']['menumpang'], 0, ',', '.') }}</div>
                 ...
                 <div class="flex items-center space-x-2">
                    ...
                    <div>
                        <div class="text-xs font-bold">{{ number_format($this->stats['totals']['status']['belum'], 0, ',', '.') }}</div>
                ...
                <table class="w-full text-sm text-left">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="p-3 text-right border-r border-gray-200">{{ number_format($row['mandiri'], 0, ',', '.') }}</td>
                            <td class="p-3 text-right border-r border-gray-200">{{ number_format($row['menumpang'], 0, ',', '.') }}</td>
        ...
        <div>
            ...
            <div class="grid grid-cols-3 gap-2 mb-4">
                 <div class="flex items-center space-x-2">
                    ...
                    <div>
                        <div class="text-xs font-bold">{{ number_format($this->stats['totals']['moda']['online'], 0, ',', '.') }}</div>
                 ...
                 <div class="flex items-center space-x-2">
                    ...
                    <div>
                        <div class="text-xs font-bold">{{ number_format($this->stats['totals']['moda']['semi'], 0, ',', '.') }}</div>
                 ...
                 <div class="flex items-center space-x-2">
                    ...
                    <div>
                        <div class="text-xs font-bold">{{ number_format($this->stats['totals']['moda']['belum'], 0, ',', '.') }}</div>
                ...
                <table class="w-full text-sm text-left">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-gray-50">
                            <td class="p-3 text-center border-r border-gray-200">{{ $index + 1 }}</td>
                            <td class="p-3 font-medium border-r border-gray-200">{{ $row['jenjang'] }}</td>
                            <td class="p-3 text-right border-r border-gray-200">{{ number_format($row['online'], 0, ',', '.') }}</td>
                            <td class="p-3 text-right border-r border-gray-200">{{ number_format($row['semi'], 0, ',', '.') }}</td>
                            <td class="p-3 text-right">{{ number_format($row['belum'], 0, ',', '.') }}</td>
                        </tr>
                        @endforeach
                    </tbody>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden overflow-x-auto">
            <table class="w-full text-sm text-left">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="p-3 text-center border-r border-gray-200">{{ $index + 1 }}</td>
                        <td class="p-3 font-medium text-blue-600 border-r border-gray-200">{{ $row['wilayah'] }}</td>
                        
                        {{-- Status --}}
                        <td class="p-3 text-right border-r border-gray-200">{{ number_format($row['status']['mandiri'], 0, ',', '.') }}</td>
                        <td class="p-3 text-right border-r border-gray-200">{{ number_format($row['status']['menumpang'], 0, ',', '.') }}</td>
                        <td class="p-3 text-right border-r border-gray-200">{{ number_format($row['status']['belum'], 0, ',', '.') }}</td>

                        {{-- Moda --}}
                        <td class="p-3 text-right border-r border-gray-200">{{ number_format($row['moda']['online'], 0, ',', '.') }}</td>
                        <td class="p-3 text-right border-r border-gray-200">{{ number_format($row['moda']['semi'], 0, ',', '.') }}</td>
