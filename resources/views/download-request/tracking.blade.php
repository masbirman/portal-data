                        ...
                        <div
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                @elseif($request->status === 'rejected')
                                    <div
                                        class="flex-shrink-0 w-10 h-10 bg-red-100 dark:bg-red-900/40 rounded-full flex items-center justify-center">
                                ...
                                @else
                                    <div
                                        class="flex-shrink-0 w-10 h-10 bg-yellow-100 dark:bg-yellow-900/40 rounded-full flex items-center justify-center">
                        ...
                        <div class="px-6 py-4">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="font-semibold text-gray-900 dark:text-white">
                                        {{ $request->wilayah_id ? $request->wilayah->nama ?? '-' : 'Semua Wilayah' }}</p>
                                </div>
                                <div>
                                    <p class="text-sm text-gray-500 dark:text-gray-400">Jenjang</p>
                                    <p class="font-semibold text-gray-900 dark:text-white">
                                        {{ $request->jenjang_pendidikan_id ? $request->jenjangPendidikan->nama ?? '-' : 'Semua Jenjang' }}
                                    </p>
                                </div>
                                <div>
                                ...
                                @if ($request->isTokenValid())
                                    <div class="mt-4 p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
                                        <p class="text-sm text-green-800 dark:text-green-200">
                                            <strong>Link berlaku hingga:</strong>
                                            {{ $request->token_expires_at->format('d M Y, H:i') }} WITA
                                        </p>
                                ...
                                @else
                                    <div
                                        ...
                                        <p class="text-sm font-semibold text-red-800 dark:text-red-200">
                                            ⚠️ Link download sudah kadaluarsa
                                        </p>
                                        <p class="text-sm text-red-700 dark:text-red-300 mt-1">
                                            Link download Anda sudah tidak berlaku sejak
                                            {{ $request->token_expires_at->format('d M Y, H:i') }} WITA.
                                            Silakan hubungi admin untuk meminta perpanjangan link download.
                                        </p>
                                    </div>
                                @endif
                            @elseif($request->status === 'rejected' && $request->admin_notes)
                                <div class="mt-4 p-4 bg-red-50 dark:bg-red-900/20 rounded-lg">
                                    <p class="text-sm font-semibold text-red-800 dark:text-red-200 mb-1">Alasan Penolakan:
                                    </p>
